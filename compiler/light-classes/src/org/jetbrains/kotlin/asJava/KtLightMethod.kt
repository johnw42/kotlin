...
sealed class KtLightMethodImpl(
    ...
    private val returnTypeElem by lazy(LazyThreadSafetyMode.PUBLICATION) {
        ...
        delegateTypeElement?.let { ClsTypeElementImpl(this, it.canonicalText, 0.toChar()) }
    }
    ...
    // override getReturnType() so returned type resolve to type parameters of this method not delegate's
    // used by java type inference
