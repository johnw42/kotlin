    ...
    companion object {
        @JvmStatic fun create(
            ...
            val functionDescriptorWithContinuationReturnType =
                    functionDescriptor.newCopyBuilder().setReturnType(continuationSupertype).build()!!
            ...
            return CoroutineCodegen(
                    state,
                    declaration,
                    expressionCodegen.context.intoClosure(functionDescriptorWithContinuationReturnType, expressionCodegen, state.typeMapper),
