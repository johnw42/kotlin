...
class CoroutineCodegen(
    ...
    override fun generateClosureBody() {
        ...
        val combinedResumeFunctionDescriptor =
                resumeFunctionDescriptor.newCopyBuilder()
                        ...
                        .setValueParameters(
                                listOf(
                                        resumeFunctionDescriptor.valueParameters[0],
                                        resumeWithExceptionFunctionDescriptor.valueParameters[0].replaceIndex(1)))
                        .build()!!
    ...
    companion object {
        @JvmStatic fun create(
            ...
            val classDescriptor = expressionCodegen.bindingContext[CodegenBinding.CLASS_FOR_CALLABLE, functionDescriptor] ?: return null
            ...
            val functionDescriptorWithContinuationReturnType =
                    functionDescriptor.newCopyBuilder().setPreserveSourceElement().setReturnType(continuationSupertype).build()!!

            expressionCodegen.state.bindingTrace.record(
                    CodegenBinding.CLASS_FOR_CALLABLE, functionDescriptorWithContinuationReturnType, classDescriptor)
            ...
            return CoroutineCodegen(
                    ...
                    expressionCodegen.context.intoCoroutineClosure(
                            functionDescriptor, functionDescriptorWithContinuationReturnType, expressionCodegen, state.typeMapper),
                    ...
                    functionDescriptor.controllerTypeIfCoroutine!!)
        }
    }
}
