...
class CleanStackOnReturnTransformer : MethodTransformer() {
    override fun transform(internalClassName: String, methodNode: MethodNode) {
        ...
        returns.reversed().forEach { insn ->
            ...
            methodNode.cleanStack(insn, frame, returnSize, maxLocalsCalculator.maxLocals)
        }
        methodNode.accept(maxLocalsCalculator)
        methodNode.maxLocals = maxLocalsCalculator.maxLocals
    }

    private fun MethodNode.cleanStack(returnInsn: AbstractInsnNode, frame: Frame<BasicValue>, returnType: Type, maxLocals: Int) {
        ...
        InlineCodegenUtil.insertNodeBefore(methodNodeStub, this, returnInsn)
    }
